...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        left_side_correct = (
            abs(left_elbow.x - left_shoulder.x) < 0.16 and  # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
            abs(left_hand.x - mouth.x) < 0.12 and  # ตรวจสอบให้ข้อมืออยู่ใกล้กับปากในระยะ 0.1
            abs(nose.y - left_shoulder.y) <0.1
        )
        
        right_side_correct = (
            abs(right_elbow.x - right_shoulder.x) < 0.16 and  # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
            abs(right_hand.x - mouth.x) < 0.12 and  # ตรวจสอบให้ข้อมืออยู่ใกล้กับปากในระยะ 0.1
        ...
        if left_side_correct or right_side_correct:
            ...
            start_time = None
            text = "ท่าที่ 1 ท่าทางไม่ตรงกับที่ต้องการ"
    else:
        start_time = None
        text = "ท่าที่ 1 ท่าทางไม่ตรงกับที่ต้องการ"
