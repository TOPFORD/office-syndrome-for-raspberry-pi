...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        left_side_correct = (
            abs(right_elbow.x - left_shoulder.x) < 0.1 # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
        )
        
        right_side_correct = (
            abs(left_elbow.x - right_shoulder.x) < 0.1 # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
        )
        ...
        if left_side_correct or right_side_correct:
            ...
            start_time = None
            text = "ท่าที่ 3 ท่าทางไม่ตรงกับที่ต้องการ"
    else:
        start_time = None
        text = "ท่าที่ 3 ท่าทางไม่ตรงกับที่ต้องการ"
