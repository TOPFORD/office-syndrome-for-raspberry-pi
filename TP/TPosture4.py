...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        left_side_correct = (
            abs(left_elbow.y >  left_shoulder.y) < 0.4 and  # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
            abs(left_hand.x - right_shoulder.x) < 0.1 and # ตรวจสอบให้ข้อมืออยู่ใกล้กับปากในระยะ 0.1
            abs(left_shoulder.y <  right_elbow.y) and
            abs(left_shoulder.x -  right_elbow.x) < 1
        )
        
        right_side_correct = (
            abs(right_elbow.y > right_shoulder.y) < 0.4 and  # ตรวจสอบให้ศอกอยู่ใกล้กับปากในระยะ 0.4
            abs(right_hand.x - left_shoulder.x) < 0.1 and # ตรวจสอบให้ข้อมืออยู่ใกล้กับปากในระยะ 0.1
        ...
        if left_side_correct or right_side_correct:
            ...
            start_time = None
            text = "ท่าที่ 4 ท่าทางไม่ตรงกับที่ต้องการ"
    else:
        start_time = None
        text = "ท่าที่ 4 ท่าทางไม่ตรงกับที่ต้องการ"
